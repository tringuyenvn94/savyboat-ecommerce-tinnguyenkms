...
<div class="header">
    ...
    <div class="header-links-wrapper">
       <div> <nopCommerce:NewsLetterSubscriptionBoxControl runat="server" ID="ctrlNewsLetterSubscriptionBoxControl" /></div>
       ...
       <div>            
        ...
        <div class="header-links">
            <ul>
                ...
                <li><a href="<%= SEOHelper.GetMyAccountUrl()%>" class="ico-cart">
