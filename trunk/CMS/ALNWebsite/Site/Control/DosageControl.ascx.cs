...
{
    public partial class DosageControl : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (WebSercurity.IsLogged() == false)
                    Btncalculation.Text = "Please Sign In";
                else
                    Btncalculation.Text = "Calculator";
            }
        }
        ...
        protected void Btncalculation_Click(object sender, EventArgs e)
        {
            ...
            if (btn.Text == "Calculator")
            {
                if (TxtAeration.Text != "" && TxtInfluentCOD.Text != "")
                {
                    ...
                    panel.Alert("Please Input Data For Calculator");
            }
            else
            {
                Response.Redirect("~/Site/Pages/SignIn.aspx?lasturl=Dosage.aspx");
            }
