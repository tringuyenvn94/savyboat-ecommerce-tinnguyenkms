...
{
    public partial class AddEditProduct : BaseUserControl
    {
        ...
        {
            LanguageContent tocValue = DataBinder.Eval(DataItem, "Name") as LanguageContent;
            ...
            object tocValue4 = DataBinder.Eval(DataItem, "Timeexpiration");
                ...
                {
                    rtxtProductName.Text = tocValue.ToLanguage(ClassLibary.Objects.Enumerable.Languages.Vietnamese);
