<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddEditProduct.ascx.cs" Inherits="ALNWebsite.Management.News.AddEditProduct" %>
<table id="Table2" cellspacing="2" cellpadding="1" width="100%" border="1" rules="none"
    ...
    <tr>
     ...
     <tr>
        <td>TitleVN:</td>
        <td><telerik:RadTextBox ID="rtxtProductNamevn"  runat="server" Width="200px" ></telerik:RadTextBox></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
